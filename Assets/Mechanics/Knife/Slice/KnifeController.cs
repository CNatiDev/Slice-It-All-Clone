...
public class KnifeController : MonoBehaviour
{
    ...
    private float _forceAppliedToCutUp = 3f;
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        GameObject[] slices = Slicer.Slice(plane, other.gameObject ,_forceAppliedToCut);
        Destroy(other.gameObject);
        // Add forward force, and in Slice() form Slicer add left or right
        Rigidbody rigidbody = slices[1].GetComponent<Rigidbody>();
        Vector3 newNormal = transformedNormal + Vector3.up * _forceAppliedToCutUp;
